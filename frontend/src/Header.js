        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex md:space-x-2">
              <NavLink to="/dashboard" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="text-gray-500 hover:bg-gray-100 hover:text-gray-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">Tableau de Bord</NavLink>
              <NavLink to="/settings" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="text-gray-500 hover:bg-gray-100 hover:text-gray-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">Paramètres</NavLink>
            </div>
          </div>
