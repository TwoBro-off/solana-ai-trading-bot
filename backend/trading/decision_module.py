...
class DecisionModule:
    ...
    """
    def __init__(self, order_executor: Any, buy_amount_sol: float, sell_multiplier: float, trailing_stop_percent: float, simulation_mode: bool = False):
        ...
        self.creator_cache_file = os.path.join(LOGS_DIR, "successful_creators.json")
